 ...
 * NYU WP Root Theme.
 *
 * This file adds default theme settings.
 *
 * @package WP Root
...
add_filter( 'genesis_theme_settings_defaults', 'wproot_theme_defaults' );
/**
 ...
 */
function wproot_theme_defaults( $defaults ) {
...
// NOTE - Not sure where this is implemented so leaving in place for now.
